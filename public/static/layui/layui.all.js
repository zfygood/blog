...
layui.define("layer", function (e) {
    ...
    var d = function () {
        ...
        return layui.each(d, function (e, l) {
            ...
            i.name = (i.name || "").replace(/^\s*|\s*&/, ""), i.name && (/^checkbox|radio$/.test(i.type) && !i.checked || (/^.*\[\]$/.test(i.name) && (i.name = i.name.replace(/^(.*)\[\]$/, "$1[" + p++ + "]")), c[i.name] = i.value))
